...
namespace ilkProje.Handlers
{
    public class ImageHandler
    {
        public RequestDelegate Handler(string imagePath)
        {
            return async c =>
            {
                FileInfo fileInfo = new FileInfo($"{imagePath}\\{c.Request.RouteValues["imageName"].ToString()}");
                ...
                await c.Response.WriteAsync(imagePath);
            };
        }
    }
}
